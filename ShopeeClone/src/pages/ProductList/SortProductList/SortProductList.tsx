    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button className='h-8 px-4 capitalize bg-orange text-white text-sm text-center hover:bg-orange/80'>
            Phổ biến
          </button>
          <button className='h-8 px-4 capitalize bg-white text-black text-sm text-center hover:bg-slate-100'>
            Mới nhất
          </button>
          <button className='h-8 px-4 capitalize bg-white text-black text-sm text-center hover:bg-slate-100'>
            Bán chạy
